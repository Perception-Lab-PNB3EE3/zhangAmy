...
generate_rt <- function(condition, trial) {
  if (condition == "1.0x") {
    return(rnorm(1, mean = 4500 + (trial * 10), sd = 1000))  
  } else if (condition == "1.5x") {
    return(rnorm(1, mean = 5000 + (trial * 30), sd = 1000))
  } else if (condition == "1.7x") {
    return(rnorm(1, mean = 5700 + (trial * 75), sd = 1000))  
...
trial and condition\*trial interaction (*p=0.82311*), meaning that
...
```{r}
condition_colors <- c("#E69F00", "#D55E00", "#CC79A7", "#0072B2")
